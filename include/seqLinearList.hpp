...
namespace cs202 {
      ...
      public:
        ...
        class iterator{                             
          ...
          public:
            ...
            void operator--() {elem_ -= 1;}
            bool operator!=(T* ptr) { if(elem_ != ptr)
                                         return true;
                                      else
                                        return false;
            }
    ...
    template<class T> LinearList<T> :: LinearList(const int& isize){
    ...
    template<class T> LinearList<T> :: LinearList(const int& isize, const T& ival){
    ...
    template<class T> inline T&  LinearList<T> :: operator[](const int& i){
        
        return buffer_[i];
    }


    template<class T> T&  LinearList<T> :: at(const int& k){

        return *(buffer_ + k);
    }

    template<class T> void  LinearList<T> :: push_back(const T& k){
    ...
    template<class T>bool  LinearList<T> :: empty(){
        if (size_ == 0) 
            return true;
    ...
    template<class T>unsigned int  LinearList<T> :: size(){
     ...
     template<class T>unsigned int LinearList<T> ::  capacity(){
        return capacity_;
    }

    template<class T>void  LinearList<T> :: fill(const T& item){   
    ...
    template<class T>void  LinearList<T> :: resize(const int & n){
    ...
    template<class T> int LinearList<T> :: find(const T& item){    
    ...
    template<class T>void LinearList<T> :: erase_pos(const int &pos){                                                             
    ...
    template<class T>void  LinearList<T> :: insert(const T& item,const int& k){                                                                                       
